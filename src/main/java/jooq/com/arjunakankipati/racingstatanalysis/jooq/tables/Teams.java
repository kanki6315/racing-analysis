...
public class Teams extends TableImpl<TeamsRecord> {
     ...
     */
    public final TableField<TeamsRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<TeamsRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.CLOB, this, "");
    ...
    @Override
    public Identity<TeamsRecord, Long> getIdentity() {
        return (Identity<TeamsRecord, Long>) super.getIdentity();
    }
